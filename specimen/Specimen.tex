...
\textsc{EFC Domitian} is a project to develop a full-featured, free and open-source implementation of Hermann Zapf's Palatino design.
...
%% Chinese - Pinyin
% Basic manual fixes to Google Translate's transcription, so might have some errors.
% FONT-TODO: Third tone characters are missing.
% \paragraph*{Kèláodé Jiālāméng}(fǎyǔ:Claude Garamont; dàyuē 1505-1561; yībān chēng wèi Claude Garamond) shì yī míng láizì bālí de fàguó zìtǐ shèjì shī, chūbǎn zhě hé huózì chōngyā shī. Yóuyú tā dào xiànjīn réng yīn tāsuǒ shèjì zìtǐ yōuyǎ ér bèi zànyáng, suǒyǐ tā bèi shì wéi shǐshàng qízhōng yīgè zuì lǐngxiān de zìtǐ shèjì shī zhī yī. Shù zhǒng xiàndài zìtǐ, lìrú Garamond, Granjon hé Sabon dōu bèi tā de fēnggé yǐngxiǎng. Jiālāméng shì dì yī gè zhuānmén wèi tārén shèjì zìtǐ hé chōngyā huózì de rén, suǒyǐ wéi dì yī gè xiàng qítā yìnshuā zhě xiāoshòu huózì zhě. Tā sùzàole shāngyè yìnshuā, yǐjí xiézhùle xīn zìtǐ de chuánbò. Jiālāméng shì āntuōwàn àorèluó (Antoine Augereau) de túdì, yǐjí kěnéng céng bèi xīméng·dé kē lì nà xùnliàn. Hòulái tā yǔ rénwén zhǔyì zìtǐ shèjì shī ruò fú lǔ wǎ·tuō lǐ hézuò, bìng kěnéng zài qíjiān yǐngxiǎngle jiā lā méng de shèjì fēnggé.
% {\scriptsize Wéijī bǎikē}

% Vietnamese has many missing features
% %% Vietnamese
% \begin{vietnamese}
...
\subsection{Figures}
For many purposes, tabular (all figures have the same width) and/or lining figures (they are about caps height) are preferred. However, in books and other long texts, "old-style" numerals are preferred, which can be accessed using the feature \texttt{onum}.
The combinations are:
\begin{tabbing}
 Oldstyle (medieval)8888 \= 88888888888888  \= 88888888888888 \kill
  \> Proportional \> Tabular \\
 Oldstyle (medieval) \> {\addfontfeature{RawFeature=+onum}12345678.90} \> {\addfontfeature{RawFeature=+onum}12345678.90} \\
 Lining		\> {12345678.90} \> {12345678.90} \\
\end{tabbing}

% FONT-TODO: Make fractions
\subsection{Fractions}
The feature \texttt{frac} allows for arbitrary fractions: {\addfontfeature{RawFeature=+frac} 1234/567890}

% FONT-TODO: Make the sub- and superscripts
...
% FONT-TODO: Make c2sc by itself work properly
...
\section{Working with other fonts}

Go Mono, scaled down to 87\%, works well with Domitian as a monospace font: \textquote{The \texttt{smcp} feature enables small caps.}

Go Sans, scaled down to 92\%, works well with Domitian too: \textquote{\textsf{This is Go Sans} mixed with Domitian \textsf{in a \LaTeX document.}}
